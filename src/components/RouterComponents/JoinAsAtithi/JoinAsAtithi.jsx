...
function JoinAsAtithi({ handleCaptchaChange, captchaError, handleSubmit }) {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div
        data-aos="fade-up"
        className=" flex justify-center items-center gap-10 p-4 py-8 lg:flex-col"
      >
        <form
        ...
        >
          ...
          <div className=" w-full flex justify-center items-center relative">
            <div
              className={`absolute overflow-hidden -top-14 transition-all duration-200 p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-200 dark:bg-gray-800 dark:text-red-600 opacity-0 scale-0 ${
                captchaError !== "" ? "opacity-100 scale-[100%]" : ""
              }`}
              role="alert"
            >
              {captchaError}
